import { faEdit, faTrashAlt, faRecycle, faFilePdf, faSearch } from "@fortawesome/free-solid-svg-icons";
        ...
        <>
           <main className="container-xl mt-2" style={{ maxWidth: "100%" }}>
                    ...
                    <div className="banco-title-container">
                        <h3 className="banco-title-main">Gestion de Trámites</h3>
                        <p className="banco-subtitle">Gestiona tus Tramites desde aqui</p>
                    </div>
                </div>
